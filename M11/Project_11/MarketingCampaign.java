...
public abstract class MarketingCampaign implements Comparable
   <MarketingCampaign> {
   ...
   */
    ...
    * @param mc new Marketing Campaign object
    * @return int representing order of list
    */
   public int compareTo(MarketingCampaign mc) {
      int result = this.getName().compareToIgnoreCase(mc.getName());
      return result;
   }
}